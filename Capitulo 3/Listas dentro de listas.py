...
busca=input("\nDigite o nome do equipamento q deseja buscar: ")
for elemento in inventario:
    if busca == elemento[0]:
...
depreciacao=input("\nDigite o nome do equipamento q sera depreciado: ")
for elemento in inventario:
...
serial=int(input("\nDigite o serial do equipamento q sera excluido: "))
for elemento in inventario:
